...
| 美術生圖 | imagen、imagen-portrait、imagen-ui、generate2dsprite(像素 / HD / cel-shaded chibi 用 art_style 切)、generate2dmap、image-to-prompt、batch-image-brief、art-style-guard(生圖引擎 image-studio 由主任另行發放,缺它這幾支不能生圖) |
