...
給團隊的 Claude Code 起手包:一份會自己長大的全域設定 + 20 支實戰 skills + 3 支品管 agents。
...
| 美術生圖 | imagen、imagen-portrait、imagen-ui、imagen-banner(廣宣 / banner 生圖與驗收,20 條鐵則;**鐵則只約束廣宣圖,不外溢立繪 / UI / 插畫**)、generate2dsprite(像素 / HD / cel-shaded chibi 用 art_style 切)、generate2dmap、image-to-prompt、batch-image-brief、art-style-guard(生圖引擎 image-studio 由主任另行發放,缺它這幾支不能生圖) |
